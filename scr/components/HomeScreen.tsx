    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 p-4">
      <div className="mx-auto max-w-md">
        ...
        <div className="pt-10 text-center">
          {/* TOP EYE IMAGE (from /public/eye.png) */}
          <div className="mx-auto w-24 h-24 rounded-full border-4 border-emerald-500 flex items-center justify-center bg-white/60">
            <img
              src="/eye.png"
              alt="Food Safety Eye"
          ...
          <h1 className="mt-4 text-4xl font-semibold text-emerald-800">Food Safety Eye</h1>
          <div className="mt-1 text-lg font-semibold text-emerald-700">食安眼</div>

          <div className="mt-5 text-base font-semibold text-emerald-800">
            守護孩子健康，從食品安全開始
          </div>

          <div className="mt-2 text-sm leading-relaxed text-emerald-700">
        ...
        <div className="mt-8 grid grid-cols-4 gap-3">
          <div className="rounded-2xl bg-white/70 p-3 shadow-sm text-center">
        ...
        <div className="mt-6 space-y-3">
          <button
            type="button"
            onClick={() => onScanLabel?.()}
            disabled={!onScanLabel}
            className={`w-full rounded-2xl px-4 py-4 text-white shadow-md flex items-center justify-center gap-2
              ${onScanLabel ? "bg-emerald-600 hover:bg-emerald-700" : "bg-emerald-600/50 cursor-not-allowed"}`}
          >
          ...
          <button
            ...
            disabled={!onManualInput}
            className={`w-full rounded-2xl px-4 py-4 shadow-md flex items-center justify-center
              ${onManualInput ? "bg-pink-200 hover:bg-pink-300 text-emerald-900" : "bg-pink-200/60 cursor-not-allowed text-emerald-900/70"}`}
          >
